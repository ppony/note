...
int main(void) {
...
#if 0 /* Scan all SAU & IDAU region and read/write attribution by TT instruction. */
	SecureAttrib();
	while(1);
#endif
	...
	printf("Secure Region Code Stack: MSP(0x%08lx) PSP(0x%08lx)\n", u32MSP_s, u32PSP_s);
	...
	printf("Non-secure Region Code Stack: MSP(0x%08lx) PSP(0x%08lx)\n", u32MSP_ns, u32PSP_ns);
